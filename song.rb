...
describe "Song" do
  ...
  describe "#new" do
    it "takes in three arguments: a name, artist and genre" do
      expect{Song.new("hit me baby one more time", "Brittany Spears", "pop")}.to_not raise_error, "Your initialize method should have name, artist, and genre as arguments"
    end
  end
  ...
  describe "class variables" do
    it "has a class variable, @@count" do
      expect(Song.class_variable_get(:@@count)).to eq(3), "No class variable @@count found"
    end
